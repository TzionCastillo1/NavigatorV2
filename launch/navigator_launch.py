...
def generate_launch_description():
        ...
        declare_operation_mode_cmd = DeclareLaunchArgument(
                ...
                description='The operation mode of the camera. Using the `FIELD` mode enables checks for GPS fix. Using the `TEST` mode disables the GPS fix check. Valid modes: `FIELD, TEST`.')
